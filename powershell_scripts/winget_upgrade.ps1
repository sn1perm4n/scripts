# This script updates the winget source and then runs the upgrade command so potential updates can be seen (must be run as Administrator)
...
# winget pin add --id <APP_ID> - Disables version checking for said app (useful to prevent an app from updating)
