# This script disables unnecessary devices I don't use (and deletes an invisible monitor) in Device Manager. Some devices get re-enabled (or reappear) every time the Nvidia driver is updated.
...
$dellAW2518HFMonitor = Get-PnpDevice -InstanceId "DISPLAY\DELA103\1&8713bca&0&UID0" -ErrorAction SilentlyContinue
if ($dellAW2518HFMonitor) {
...
Write-Host "All unnnecessary Device Manager devices disabled."
