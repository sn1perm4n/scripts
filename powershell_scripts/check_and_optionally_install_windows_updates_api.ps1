...
# This script uses the Windows Update API to check for non-hidden Windows Updates, Microsoft Updates, Microsoft Defender definition updates, and attempts to update the "Last checked" timestamp in the Windows Update GUI (and ignore and optionally install updates based on user-input)
