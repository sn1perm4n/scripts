# This script stops and disables various unnecessary services in Windows 11 and must be run as Administrator, which requires the following:
...
# Substitute <PROFILE> with whatever your username is.
