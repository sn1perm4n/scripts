...
# Get-PnpDevice | Out-File -FilePath "C:\Users\reedwaller\Desktop\get-pnpdevices_output.txt"
# Can use the following command to prevent InstanceId from truncating:
# Get-PnpDevice | Format-Table -AutoSize -Wrap | Out-File -FilePath "C:\Users\reedwaller\Desktop\get-pnpdevices_output.txt"
# Can use the following command to only print non-truncated InstanceId column:
# Get-PnpDevice | Select-Object -ExpandProperty InstanceId | Out-File -FilePath "C:\Users\reedwaller\Desktop\get-pnpdevices_output.txt"
