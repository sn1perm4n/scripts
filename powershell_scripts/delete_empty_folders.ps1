...
function Remove-EmptyFolders {
	...
	Write-Host "Successfully deleted all empty folders from '$deleteEmptyFolders'."
}

# Specify the directory to process
$deleteEmptyFolders = "<INSERT_FULLY_QUALIFIED_PATH_HERE>"

# Call the function to remove empty folders
Remove-EmptyFolders -Path $deleteEmptyFolders
